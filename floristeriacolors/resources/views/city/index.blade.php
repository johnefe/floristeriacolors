...
<div class="col-md-12">
    ...
    <div class="card">
        <div class="header">
            <h4 class="title">REGISTRAR CIUDAD</h4>
             ...
             {!!Form::open(['route'=> 'ciudades.store', 'method'=>'POST'])!!}
                <div class="row">
                    <div class="col-md-12">
                        ...
                        {!!Form::text('nombre',null,['class'=>'form-control','placeholder'=>'Escribe el nombre de la ciudad'])!!}
                        </div>
                    </div>
                </div>
...
<div class="col-md-12">
    ...
    <div class="card">
        <div class="header">
            <h4 class="title">CIUDADES REGISTRADAS</h4>
                    </div>
...
<div class="col-md-6">
    <div class="card">
        <div class="header">
            <h4 class="title">ADICIONAR PRODUCTO A CIUDAD</h4>
        ...
        return retorno;
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        {{ Form::open() }}
                        {{ csrf_field() }}
                        {!!Form::label('Ciudad','Escoge la ciudad:')!!}
...
function validar(obj){
    if(obj.checked==true){
        var array = {"product_id":parseInt(obj.id),"city_id":parseInt($( "#city_id" ).val())}
        console.log(obj.id);
